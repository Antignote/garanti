		...
		<form onSubmit={handleCalculate} onReset={handleResetForm}>
			...
			<div className="flex justify-between">
				<button
					...
					type="submit"
					className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
				>
					Beräkna garanti
				</button>
				<button
